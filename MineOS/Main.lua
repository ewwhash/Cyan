...
local localizations = {
	...
	["Spanish"] = {
		...
		users = "Usuarios",
		usersNotSpecified = "Si no hay usuarios especificados, cualquiera puede acceder al cargador de arranque",
		enterPlayerName = "Introduzca nombre de jugador",
		maxLengthExited = "Se ha excedido el numero de usuarios",
		readonly = "la EEPROM esta en modo lectura",
		userInput = "Esperar entrada del usuario mientras se arranca",
		options = "Opciones",
